...
import 'package:arafah/features/shop/presentation/pages/best_selling_products_page.dart';
...
class BestSellingSection extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ShopBloc, ShopState>(
      builder: (context, state) {
        ...
        if(state.bestProductsStatus.isSuccess && state.bestSellingProducts.isNotNullAndNotEmpty){
          return Column(
            ...
            children: [
              ...
              SectionHeader(
                ...
                actionText: "See All",
                onActionTap: () {
                  context.go(ShopPage.path + BestSellingProductsPage.path);
                },
              ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    Product product = state.bestSellingProducts![index];
