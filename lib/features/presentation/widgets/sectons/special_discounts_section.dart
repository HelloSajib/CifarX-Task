...
import 'package:arafah/features/shop/presentation/pages/discount_products_page.dart';
...
class SpecialDiscountsSection extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ShopBloc, ShopState>(
      builder: (context, state) {
        ...
        if(state.discountsProductsStatus.isSuccess && state.discountsProducts.isNotNullAndNotEmpty){
          return Column(
            ...
            children: [
              ...
              SectionHeader(
                ...
                actionText: "See All",
                onActionTap: () {
                  context.go(ShopPage.path + DiscountProductsPage.path);
                },
              ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: state.discountsProducts?.length,
                  itemBuilder: (context, index) {

                    Product product = state.discountsProducts![index];
